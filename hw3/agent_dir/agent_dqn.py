...
class Agent_DQN(Agent):
    def __init__(self, env, args):
        ...
        self.name = 'dqn_double_512_max_3'
        self.env = env
    ...
    def _build_network(self):
        ...
        net = layers.Dense(self.output_dim, activation='linear')(net)

        self.online_network = Model(inputs=_input, outputs=net)
        ...
        self.target_network = Model(inputs=_input, outputs=net)
